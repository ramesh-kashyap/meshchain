                ...
                <div className="grid grid-cols-1 lg:grid-cols-5 xl:grid-cols-3 gap-6">
                    <div className="lg:col-span-3 xl:col-span-2 bg-white rounded-[16px] p-6">
                        ...
                        <div className="flex justify-between items-center w-full bg-[#F9F9F9] rounded-[27px] px-[40px] max-sm:px-[20px] py-[4px] max-sm:py-[10px] text-[14px] text-[#999999] my-4 sm:my-6 sm:py-6 max-sm:gap-0">
                            ...
                            <img alt="right-arrow" loading="lazy" width="30" height="30" src="http://127.0.0.1:8000/upnl/assets/icons/right-arrow-inactive.svg" style={{ color: 'transparent' }} />
                        ...
                        <div>
                            ...
                            <div className="flex items-center justify-between bg-[#F9F9F9] h-[72px] mb-2 p-[15px] rounded-[16px] cursor-pointer hover:bg-[#ebe8e8]" onClick={toggleCollapse}>
                                <div className="py-4 flex items-center space-x-2 lg:space-x-3 text-sm">
                                    <img alt="BNB logo" loading="lazy" width="40" height="40" src="http://127.0.0.1:8000/upnl/assets/icons/logo_bnb_2.svg" style={{ color: 'transparent' }} />
                                    <div>
                                        <div className="text-[16px] text-[#171717] font-semibold">BNB</div>
                                        <div className="text-[12px] text-[#999999]">BNB</div>
                                    </div>
                                </div>
                                <img alt="BNB logo" loading="lazy" width="20" height="20" src="http://127.0.0.1:8000/upnl/assets/icons/right-repo.svg" style={{ color: 'transparent' }} />
                            </div>
                            ...
                            {!isCollapsed && (
                                <div className="flex items-center justify-between bg-[#F9F9F9] h-[120px] mb-2 p-[15px] rounded-[16px] cursor-pointer hover:bg-[#ebe8e8]" onClick={toggleCollapse}>
                                    <div className="py-4 flex items-start space-x-2 lg:space-x-3 text-sm">
                                        <img alt="BSC logo" loading="lazy" width="40" height="40" src="http://127.0.0.1:8000/upnl/assets/icons/logo_bsc_2.svg" style={{ color: 'transparent' }} />
                                        <div>
                                    ...
                                    <img alt="BSC logo" loading="lazy" width="20" height="20" src="http://127.0.0.1:8000/upnl/assets/icons/right-repo.svg" style={{ color: 'transparent' }} />
                                </div>
                            )}
                            ...
                            {isEthereumVisible && (
                                <div className="flex items-center justify-between bg-[#F9F9F9] h-[120px] mb-2 p-[15px] rounded-[16px] cursor-pointer hover:bg-[#ebe8e8]">
                                    <div className="py-4 flex items-start space-x-2 lg:space-x-3 text-sm">
                                        <img alt="ETH logo" loading="lazy" width="40" height="40" src="http://127.0.0.1:8000/upnl/assets/icons/logo_eth_2.svg" style={{ color: 'transparent' }} />
                                        <div>
                                    ...
                                    <img alt="ETH logo" loading="lazy" width="20" height="20" src="http://127.0.0.1:8000/upnl/assets/icons/right-repo.svg" style={{ color: 'transparent' }} />
                                </div>
                            )}
                        </div>
                    </div>
