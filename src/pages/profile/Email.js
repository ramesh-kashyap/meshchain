                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-5 xl:grid-cols-3 gap-6">
                                <div className="lg:col-span-3 xl:col-span-2 flex flex-col">
                                    <div className="bg-white rounded-[16px] mt-6 p-6 lg:p-8 flex-1">
                                        ...
                                        <form method="post" action="user/changeEmailAction">
                                            <input type="hidden" name="_token" value="Mp8WGPpkCtxtvkezkpwvKGFaP8ckS5wUjCIsgRln" />
                                            <div className="mb-4">
                                            ...
                                            <div className="mb-4">
                                                ...
                                                <div className="input-container" style={{ position: 'relative', width: '100%' }}>
                                                    <input type="text" name="first_code" placeholder="Enter verification code" className="w-full px-3 py-2 border border-gray-300 rounded-[12px] pr-20" />
                                            ...
                                            <div className="mb-4">
                                                ...
                                                <input type="email" id="newEmail" placeholder="Please enter the new email" name="newEmail" className="w-full px-3 py-2 border border-gray-300 rounded-[12px]" />
                                            </div>
                                            <div className="mb-4">
                                                <label htmlFor="second_code" className="block text-gray-700 font-medium mb-2">Verification Code</label>
                                                <div className="input-container" style={{ position: 'relative', width: '100%' }}>
                                                    <input type="text" name="second_code" placeholder="Enter verification code" className="w-full px-3 py-2 border border-gray-300 rounded-[12px] pr-20" />
                                                    <span className="code-btn" style={{ position: 'absolute', right: '10px', top: '50%', transform: 'translateY(-50%)', cursor: 'pointer', color: 'gray' }}>
                                                        Get Code
                                                    </span>
                                                </div>
