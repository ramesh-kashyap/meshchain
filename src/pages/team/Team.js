        ...
        <div className="flex-1 overflow-y-auto px-4 md:px-10 lg:px-10 xl:px-20 pt-5 pb-[88px] md:pb-[20px] bg-[#F1F1F1]">
            <div className="w-full mt-10 flex justify-center text-primary">
                <div className="w-full max-w-[1440px] rounded-lg">
                    <div className="max-w-[1920px] w-full grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div className="bg-white p-5 rounded-[16px] flex flex-col items-left">
                            <div className="flex mb-[14px]">
                                <div className="bg-green-100 rounded-full p-2">
                                    <img alt="Total Rewards Icon" loading="lazy" width="32" height="32" src="http://127.0.0.1:8000/upnl/assets/icons/stats_reward.svg" />
                                </div>
                            </div>
                            <div>
                        ...
                        <div className="bg-white p-5 rounded-[16px] max-h-[226px] h-full flex flex-col">
                            <div className="flex items-center justify-between w-full mb-[14px]">
                                <div className="bg-blue-100 rounded-full p-2">
                                    <img alt="Today's Rewards Icon" loading="lazy" width="32" height="32" src="http://127.0.0.1:8000/upnl/assets/icons/icon_total_rewards.svg" />
                                </div>
                            </div>
                            <div>
                        ...
                        <div className="bg-white p-5 h-full rounded-[16px] flex flex-col justify-between">
                            <div>
                                <div className="flex justify-between items-center mb-[14px]">
                                    ...
                                    <button className="text-sm flex items-center h-[32px] px-4 py-1 rounded-[22px] bg-[#F1F1F1]">
                                        <img alt="Filter Icon" loading="lazy" width="20" height="20" src="http://127.0.0.1:8000/upnl/assets/icons/users.svg" />
                            ...
                            <button className="flex rounded-[24px] justify-center items-center align-center border border-[#F1F1F1] text-[#373737] bg-[#F9F9F9] h-[36px] py-2 px-3" style={{ fontFamily: 'ClashDisplay-Semibold' }}>
                                ...
                                <img alt="Copy Icon" loading="lazy" width="16" height="16" onClick={copyToClipboard} src="http://127.0.0.1:8000/upnl/assets/icons/copy_clipboard.svg" />
                            </button>
                    ...
                    <div className="space-y-4">
                        {[1, 2, 3, 4, 5].map((level) => (
                            <a key={level} href={`http://127.0.0.1:8000/user/list?selected_level=${level}`}>
            ...
            <div className="fixed bottom-0 w-full bg-white flex md:hidden justify-around shadow-lg">
                ...
                <a className="flex w-1/5 p-[12px] flex-col items-center" href="http://127.0.0.1:8000/user/node-power">
                    <img alt="My Nodes Icon" loading="lazy" width="20" height="20" src="http://127.0.0.1:8000/upnl/assets/icons/icon-nodes.svg" />
